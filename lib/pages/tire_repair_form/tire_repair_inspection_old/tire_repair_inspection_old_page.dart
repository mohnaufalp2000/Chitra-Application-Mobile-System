...
class TireRepairInspectionOldPage extends StatefulWidget {
  static const routeName = '/tire-repair-inspection-old';
  const TireRepairInspectionOldPage({super.key});

  @override
  State<TireRepairInspectionOldPage> createState() =>
      _TireRepairInspectionOldPageState();
}

class _TireRepairInspectionOldPageState
    extends State<TireRepairInspectionOldPage> with TickerProviderStateMixin {
  ...
  Future<List<String>> getRepairLocationList() async {
    final snapshot =
        await FirebaseFirestore.instance.collection('list_repair_area').get();
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  List<String> customers = snapshot.data![0] as List<String>;
                  selectedCustomer ??= customers[0];

                  final repairLocationList = snapshot.data![1] as List<String>;
                                  ...
                                  DropdownButton<String>(
                                    ...
                                    onChanged: (newValue) {
                                      setState(() {
                                        ...
                                        print(
                                            'select status : $selectedRepairLocation');
                                      });
                                    },
                                  ),
                                ],

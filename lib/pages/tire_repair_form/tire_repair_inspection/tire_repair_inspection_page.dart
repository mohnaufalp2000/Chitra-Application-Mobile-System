...
class _TireRepairInspectionPageState extends State<TireRepairInspectionPage>
  ...
  Future<List<String>> getSizeList() async {
    final snapshot = await firestore.collection('tire_size').get();
    final dataList = snapshot.docs[0].data()['size'] as List<dynamic>;
    log('size datalist : $dataList');
    return ['All', ...dataList];
  }
  ...
  Query buildFirestoreQuery() {
    ...
    if (selectedSize != null && selectedSize != 'All') {
      query = query.where('tire_size', isEqualTo: selectedSize);
    }
          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  final List<String> sizes = snapshot.data![2];
                  ...
                  return Column(
                    children: [
                      ...
                      PaginateFirestore(
                        ...
                        key: ValueKey(
                            '$selectedIndex-$selectedCustomer-$selectedStatus-$searchQuery-$selectedRepairLocation-$selectedYear-$selectedMonth-$selectedSize'),
                        query: buildFirestoreQuery(),

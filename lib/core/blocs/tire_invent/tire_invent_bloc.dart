...
//         // menentukan status yang ingin ditampilkan
//         log('site invent : $site');
//         final count = [
//           {
...
//         // save local (detail)
//         if (!prefs.containsKey('detail_tire_spec')) {
...
//             final quantity = (sizeCount[size]?.containsKey('quantity') ?? false)
...
//     //   try {
//     //     log('detail invent');
//     //     emit(TireInventLoadingState());
//     //     final listTireInvent = [];
//     //     for (var i = 10; i < int.parse(event.total); i + 10) {
//     //       listTireInvent.addAll(await ApiService.getDetailInventory(
//     //           event.status, i.toString(), event.idSite));
//     //     }
//     //     log(listTireInvent.toString());
//     //   } catch (e) {
//     //     emit(TireInventErrorState(message: e.toString()));
//     //   }
//     // });
//   }
// }
  ...
  TireInventBloc() : super(TireInventInitial()) {
    on<GetTireInventEvent>((event, emit) async {
      ...
      if (connectivityResult == ConnectivityResult.none) {
        ...
        // ambil data dari penyimpanan lokal (tidak termasuk data detail tire inventory)
      ...
      // // sudah buka aplikasi
      // // if (prefs.containsKey('tire_spec') &&
      // //     prefs.containsKey('detail_tire_spec')) {
      // //   log('sudah buka aplikasi');
      // //   final cachedData = prefs.getString('tire_spec');
      // //   final decodedData =
      // //       jsonDecode(cachedData ?? '') as Map<String, dynamic>;
      // //   emit(TireInventLoadedState(
